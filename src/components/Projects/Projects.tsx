          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <a
                ...
                className="block mb-4 relative z-10"
                aria-label={`View ${project.title} demo`}
              >
                {/* Project Image */}
                {project.image && (
                  <div className="mb-4 rounded-lg overflow-hidden h-48 hover:opacity-80 transition-opacity duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)' }}>
                    <picture>
                      <source
                        type="image/webp"
                        srcSet={`
                ...
                <h3 className="text-2xl font-semibold mb-3 text-white hover:text-[#32C4C4] transition-colors duration-300">
                  {project.title}
                </h3>
              </a>
